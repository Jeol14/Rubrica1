...
const SportCardContext = createContext();

export const useSportCardContext = () => {
  return useContext(SportCardContext);
};

export const SportCardProvider = ({ children }) => {
  ...
  return (
    <SportCardContext.Provider value={{ sportsData, addSportCard }}>
      {children}
